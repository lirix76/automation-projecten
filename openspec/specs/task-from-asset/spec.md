# task-from-asset Specification

## Purpose

Ability to initiate task creation from a Versie in the assets base, resulting in a Taken record in the projects base linked to the correct Versions record, whether or not it is linked to a project.
